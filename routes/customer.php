...
Route::group(['middleware' => ['auth.customer']], function () {
    Route::post('userexists', [\App\Http\Controllers\API\Customer\CustomerAuthController::class, 'userExists']);
    ...
    Route::post('emaillogin', [\App\Http\Controllers\API\Customer\EmailLogin::class, 'emailLogin']);
