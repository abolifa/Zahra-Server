...
Vue.prototype.$editorKey = "16ksl6vwnpiadej85qoquv6mat5xdzklsnp82j9otq6imgab";
...
Vue.prototype.$editorFont_size_formats =
...
Vue.filter("emailMask", function (value) {
    if (Vue.prototype.$isDemo === 0 || Vue.prototype.$isDemo === "0")
        return value;
    if (!value) return "";
