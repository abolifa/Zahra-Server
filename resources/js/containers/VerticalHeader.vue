        ...
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <div class="d-flex justify-content-start align-items-center">
                    <div
                        class="me-2"
                        v-if="$isDemo == 1 && windowWidth < this.$mobileWidth"
                    >
                ...
                >
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li
                            ...
                            v-if="
                                $isDemo == 1 && windowWidth > this.$mobileWidth
                            "
                        >
                        ...
                        <li class="nav-item dropdown me-2">
                            <div class="d-flex gap-2 align-items-center mt-2">
                                ...
                                >
                                    <template #title>
                                        <div
                                            class="d-flex align-content-center justify-content-sm-between"
                                        >
                        ...
                        >
                            ...
                            >
                                <i
                                    class="fa fa-solid fa-globe fs-4 text-gray-600"
                                ></i>
                            </a>
                        </li>
                        ...
                        <li class="nav-item dropdown me-1">
                            ...
                            >
                                <i
                                    class="bi bi-envelope fs-4 text-gray-600"
                                ></i>
                            </a>
                            <ul
                        ...
                        <li class="nav-item dropdown me-1">
                            ...
                            >
                                ...
                                <li
                                    ...
                                    v-for="notification of notifications.slice(
                                        0,
                                        4
                                    )"
                                >
                                ...
                                <li v-if="notifications.length > 0">
                                    <p class="text-center py-2 mb-0">
                                        <router-link to="/notification_panel"
                                            >See all notification</router-link
                                        >
                                    </p>
                                </li>
                                <li>
...
export default {
    ...
    methods: {
        ...
        changeLanguage(event) {
            ...
            axios
                .post(this.$apiUrl + "/change_language", data)
                .then((response) => {
        ...
        getNotifications(event) {
            axios
                .get(this.$apiUrl + "/get_top_notifications")
                .then((response) => {
