<template>
    <div id="app">
        <div id="sidebar" :class="['active', isRtl ? 'sidebar-rtl' : '']">
            <div class="sidebar-wrapper active">
                <div class="sidebar-header">
                    <div class="d-flex flex-row justify-content-center">
                        <div class="logo">
                            <router-link
                                class="d-flex flex-column align-items-center justify-content-center align-content-center flex-wrap"
                                to="/"
                            >
                                <img
                                    v-if="$appLogo != ''"
                    ...
                    <ul class="menu">
                        <li class="sidebar-item sidebar-search">
                            <b-form-input
                                ...
                                type="search"
                                v-on:keyup="filterItem"
                                v-on:search="filterItem"
                            ></b-form-input>
                        </li>
                        ...
                        <template v-for="item in filteredSidebarItems">
                            <li
                                ...
                                :class="{
                                    active:
                                        isActive(item.url) || subIsActive(item),
...
export default {
    ...
    methods: {
        filterItem() {
            ...
            $(`.sidebar-menu li:not(.sidebar-search)`).each(function (
                index,
                element
            ) {
                const item = $(element);
                const parentListIsNested = item
                    .closest("ul")
                    .hasClass("submenu");
