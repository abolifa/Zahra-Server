                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <span class="pull-right">
                                <template
                                    v-if="$roleSeller == login_user.role.name"
                                >
                                    <router-link
                        ...
                        <div class="card-body">
                            ...
                            <b-row class="mb-2">
                                <b-col md="2">
                                    <h6 class="box-title">
                                        {{ __("filter_by_products_category") }}
                                    </h6>
                                    <form method="post">
                                        <select
                                            @change="getRecords()"
                            ...
                            <div class="table-responsive">
                                ...
                                >
                                    <template #table-busy>
                                        <div
                                            class="text-center text-black my-2"
                                        >
                                            <b-spinner
                                                class="align-middle"
                                            ></b-spinner>
                                    ...
                                    <template #cell(stock)="row">
                                        <span v-if="row.item.is_unlimited_stock"
                                            >Unlimited</span
                                        >
                                        <template v-else>
                                            {{ row.item.stock }}
                                            <span v-if="row.item.stock_unit">{{
                                                row.item.stock_unit
                                            }}</span>
                                        </template>
                                    ...
                                    <template #cell(availability)="row">
                                        ...
                                        >
                                            <span
                                                class="primary-toggal"
                                                v-if="row.item.status == 1"
                                                ><i
                                                    class="fa fa-toggle-on fa-2x"
                                                ></i
                                            ></span>
                                            <span class="text-danger" v-else
                                                ><i
                                                    class="fa fa-toggle-off fa-2x"
                                                ></i
                                            ></span>
                                        </a>
                                    </template>
                                    ...
                                    <template #cell(indicator)="row">
                                        <span
                                            class="badge bg-info"
                                            v-if="row.item.indicator == 0"
                                            >None</span
                                        >
                                        <span
                                            class="badge bg-success"
                                            v-if="row.item.indicator == 1"
                                            >Veg</span
                                        >
                                        <span
                                            class="badge bg-danger"
                                            v-if="row.item.indicator == 2"
                                            >Non-Veg</span
                                        >
                                    </template>
                                    <template #cell(is_approved)="row">
                                        <span
                                            class="badge bg-success"
                                            v-if="row.item.is_approved == 1"
                                            >Approved</span
                                        >
                                        <span
                                            class="badge bg-danger"
                                            v-if="row.item.is_approved == 0"
                                            >Not-Approved</span
                                        >
                                    </template>
                                    <template #cell(return_status)="row">
                                        <span
                                            class="badge bg-danger"
                                            v-if="row.item.return_status == 0"
                                            >Not-Allowed</span
                                        >
                                        <span
                                            class="badge bg-success"
                                            v-if="row.item.return_status == 1"
                                            >Allowed</span
                                        >
                                    </template>
                                    ...
                                    <template #cell(till_status)="row">
                                        <span
                                            class="badge bg-danger"
                                            v-if="row.item.till_status == '0'"
                                            >Not Applicable</span
                                        >
                                        <span
                                            class="badge bg-success"
                                            v-if="row.item.till_status == '2'"
                                            >{{
                                                row.item.till_status_name
                                            }}</span
                                        >
                                        <span
                                            class="badge bg-success"
                                            v-if="row.item.till_status == '3'"
                                            >{{
                                                row.item.till_status_name
                                            }}</span
                                        >
            ...
            this.$swal
                ...
                .then((result) => {
                    if (result.value) {
                        ...
                        axios
                            .post(this.$apiUrl + "/products/delete", postData)
                            .then((response) => {
                                this.isLoading = false;
                                let data = response.data;
            ...
            this.$swal
                ...
                .then((result) => {
                    if (result.value) {
                        ...
                        axios
                            .post(this.$apiUrl + "/products/change", postData)
                            .then((response) => {
                                this.isLoading = false;
                ...
                this.$swal
                    ...
                    .then((result) => {
                        if (result.value) {
                            ...
                            axios
                                .post(
                                    this.$apiUrl + "/products/multiple_delete",
                                    postData
                                )
                                .then((response) => {
                                    this.isLoading = false;
