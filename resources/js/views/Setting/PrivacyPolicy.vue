                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <vue-editor
                                    :placeholder="
                                        __('Enter Returns and Exchanges Policy')
                                    "
                                    v-model="
                                        policies.returns_and_exchanges_policy
                                    "
                                ></vue-editor>
                            </div>
                            <div class="form-group">
                                ...
                                <vue-editor
                                    :placeholder="__('Enter Shipping Policy')"
                                    v-model="policies.shipping_policy"
                                ></vue-editor>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <vue-editor
                                    :placeholder="
                                        __('Enter Update Terms Conditions')
                                    "
                                    v-model="policies.terms_conditions"
                                ></vue-editor>
                            </div>
