                        ...
                        >
                            <ol class="breadcrumb">
                                ...
                                <li
                                    ...
                                    aria-current="page"
                                >
                                    Delivery boy Privacy Policy And Terms &
                                    Conditions
                                </li>
                            </ol>
                        </nav>
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <vue-editor
                                    ...
                                    v-model="
                                        policies.privacy_policy_delivery_boy
                                    "
                                ></vue-editor>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <vue-editor
                                    :placeholder="
                                        __('Enter Terms & Conditions')
                                    "
                                    v-model="
                                        policies.terms_conditions_delivery_boy
                                    "
                                ></vue-editor>
                            </div>
                        </div>
...
export default {
    components: { editor: Editor, VueEditor },
    data: function () {
        return {
    ...
    methods: {
        getPrivacyPolicyDeliveryBoy() {
            axios
                .get(this.$apiUrl + "/privacy_policy_delivery_boy")
                .then((response) => {
