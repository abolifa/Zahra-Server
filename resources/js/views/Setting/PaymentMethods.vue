                ...
                <form id="payment_method_settings_form" method="post" enctype="multipart/form-data" @submit.prevent="saveRecord">
                    <div class="row">
                        ...
                        <div class="col-6 mb-4">
                            <div class="card h-100">
                                <div class="card-header">
                                    <h4 class="card-title">TLYNC Payments</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="razorpay_payment_method">TLYNC Payments <small>[ Enable / Disable ] </small></label><br>
                                        <div class='form-check form-switch'>
                                            <input class='form-check-input' id="razorpay_payment_method" type='checkbox' true-value="1" false-value="0" v-model="payment_method.tlync_payment_method" :checked="payment_method.tlync_payment_method">
                                        </div>
                                    </div>
                                    <div v-if="payment_method.tlync_payment_method == 1" class="form-group">
                                        <label for="tlync_key">TLYNC key ID</label>
                                        <input type="text" class="form-control" name="tlync_key" id="tlync_key" v-model="payment_method.tlync_key" placeholder="TLYNC Key ID">
                                    </div>
                                    <div v-if="payment_method.tlync_payment_method == 1" class="form-group">
                                        <label for="tlync_secret_key">Secret Key</label>
                                        <input type="text" class="form-control" name="tlync_secret_key" id="tlync_secret_key" v-model="payment_method.tlync_secret_key" placeholder="TLYNC Secret Key ">
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
   ...
   this.payment_method.tlync_payment_method = this.record.tlync_payment_method;
                    this.payment_method.tlync_key = this.record.tlync_key;
                    this.payment_method.tlync_secret_key = this.record.tlync_secret_key;
