    ...
    <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            />
                                            <div v-if="errors.categories_ids" class="text-danger">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        />
                                        <p
                                            v-if="commissionvalidationError"
                                            class="error"
                                        >
                                        ...
                                        >
                                            Will be used if category wise
                                            commission not set.
                                            <a
                                                href="javascript:void(0)"
                                                @click="commissionRule = true"
                                                title="How it works"
                                                >How seller commission works?</a
                                            >
                                        </span>
                                    </div>
                                    <br />
                                    <div class="form-group col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div
                                                ...
                                                "
                                                @click="
                                                    $refs.file_national_id_card.click()
                                                "
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <span
                                            class="text-danger d-block font-size-13"
                                            >*Only Search Location, When Update
                                            is necessary</span
                                        >
                                        <span
                                            class="text text-primary font-size-13"
                                            >Search your seller name and you
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div
                                            v-if="formatted_address"
                                            class="text-danger"
                                        >
                                            *Drag and click marker to your shop
                                            proper location (This will affect
                                            into delivery charge calculation)
                                        </div>
                                        <div
                                            id="map"
                                            style="
                                        ...
                                        <div v-if="formatted_address">
                                            <span
                                                class="title font-weight-bolder"
                                                ><b>{{ place_name }}</b> -
        ...
        >
            <b-container fluid>
                <ol>
                    <li>
                        Cron job must be set (For once in a day) on your server
                        for seller commission to be work.
                    </li>
                    ...
                    <li>
                        ...
                        <b
                            ...
                            seller commission percentage</b
                        >
                    </li>
                    <li>
                        For example sub total is 1378 and seller commission is
                        20% then 1378 / 100 X 20 = 275.6 so 1378 - 275.6 =
                        1102.4 will get credited into seller's wallet.
                    </li>
                    <li>
                        If Order status is delivered then only seller will get
                        commisison.
                    </li>
                    <li>
                        Ex - 1. Order placed on 11-Aug-21 and product return
                        days are set to 0 so 11-Aug + 0 days = 11-Aug seller
                        commission will get credited on 12-Aug-21 at 12:00 AM
                        (Mid night)
                    </li>
                    <li>
                        Ex - 2. Order placed on 11-Aug-21 and product return
                        days are set to 7 so 11-Aug + 7 days = 18-Aug seller
                        commission will get credited on 19-Aug-21 at 12:00 AM
                        (Mid night)
                    </li>
                    <li>
                        If seller commission doesn't works make sure cron job is
                        set properly and it is working. If you don't know how to
                        set cron job for once in a day please take help of
                        server support or do search for it.
                    </li>
                </ol>
            </b-container>
...
export default {
    ...
    methods: {
        validateForm() {
            // Reset errors
            this.errors.categories_ids = null;

            // Check if categories_ids is empty
            if (this.categories_ids.length === 0) {
                this.errors.categories_ids = "This field is required.";
                return false;
            }
        ...
        getCategories() {
            this.isLoading = true;
            axios
                .get(this.$apiUrl + "/categories/main")
                .then((response) => {
                    this.isLoading = false;
                    let data = response.data;
            ...
            geocoder.geocode({ location: latlng }, function (results, status) {
                if (status === "OK") {
                    if (results[1]) {
                        ...
                        let addressArr =
                            clikedPlace.formatted_address.split(",");
        ...
        handleFileNationalIdCard() {
            ...
            this.national_id_card_url = URL.createObjectURL(
        ...
        validateMobileNumber() {
            ...
            if (!/^\d{1,16}$/.test(mobileNumber)) {
                this.mobilevalidationError =
                    "Mobile Number must be maximum 16 digits numbers.";
                this.mobile = null;
            } else {
        ...
        validateCommission() {
            if (this.commission < 1 || this.commission > 100) {
                this.commissionvalidationError =
        ...
        validateAccountNumber() {
            if (this.account_number < 1) {
                this.account_numbervalidationError =
                    "Account Number must be numeric value.";
        ...
        getSeller() {
            axios
                .get(this.$apiUrl + "/sellers/edit/" + this.id)
                .then((response) => {
                    this.isLoading = false;
                    let data = response.data;
                    if (data.status === 1) {
                        ...
                        this.admin_id =
                            this.record.admin.id ?? this.record.admin_id;
                        this.name =
                            this.record.admin.username ?? this.record.name;
                        this.email =
                            this.record.admin.email ?? this.record.email;
                        ...
                        this.require_products_approval =
                            this.record.require_products_approval;
                        this.customer_privacy = this.record.customer_privacy;
                        this.view_order_otp = this.record.view_order_otp;
                        this.assign_delivery_boy =
                            this.record.assign_delivery_boy;
                        this.change_order_status_delivered =
                            this.record.change_order_status_delivered;
                        this.status = this.record.status;
                        this.store_logo = this.record.store_logo;

                        this.store_logo_url =
                            this.$storageUrl + this.record.logo;
                        this.national_id_card_url =
                            this.$storageUrl +
                            this.record.national_identity_card;
                        this.address_proof_url =
                            this.$storageUrl + this.record.address_proof;
