        ...
        <form ref="my-form" @submit.prevent="saveRecord">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="amount" id="amount" v-model="walletTransaction.amount" v-on:keyup="checkAmount" required class="form-control" placeholder="Enter Transfer Amount" @input="validateAmount">
